...
<body>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed show" href="website-profile.html">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed show" href="data-admin.html">
          <svg console.log(object); xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" class="bi bi-house-door me-2" viewBox="0 0 16 16">
            <path d="M8.354 1.146a.5.5 0 0 0-.708 0l-6 6A.5.5 0 0 0 1.5 7.5v7a.5.5 0 0 0 .5.5h4.5a.5.5 0 0 0 .5-.5v-4h2v4a.5.5 0 0 0 .5.5H14a.5.5 0 0 0 .5-.5v-7a.5.5 0 0 0-.146-.354L13 5.793V2.5a.5.5 0 0 0-.5-.5h-1a.5.5 0 0 0-.5.5v1.293L8.354 1.146ZM2.5 14V7.707l5.5-5.5 5.5 5.5V14H10v-4a.5.5 0 0 0-.5-.5h-3a.5.5 0 0 0-.5.5v4H2.5Z"/>
          </svg>
              ...
              <div class="tab-content pt-2">
                ...
                <div style="margin-left: 120px;" class="tab-pane fade show active profile-overview" id="profile-overview">
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8">Ngijo</div>
                  </div>

                  <div class="row" >
                    <div class="col-lg-3 col-md-4 label">Propinsi</div>
                    <div class="col-lg-9 col-md-8">Jatim</div>
                  </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8">karangploso</div>
                  </div>

                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">Email</div>
                    <div class="col-lg-9 col-md-8">ngijo@gamil.com</div>
                  </div>

                  <div class="row"><br>
                    <div class="col-lg-3 col-md-4 label">Kode Pos</div>
                    <div class="col-lg-9 col-md-8">78283</div>
                  </div>

                  <div class="row">
                    <div class="col-lg-4 col-md-4 label">Gambar Persetujuan Desa</div>
                    <div class="col-lg-9 col-md-8" style="margin-top: 40px; margin-right: 60px;"><img src="img/surat.webp" alt=""></div>
                  </div>
                  <a href="data-admin.html" style="margin-left: 210px;"><button class="button-79 ms-0 mb-3" role="button">Kembali</button></a>
                </div>
                </div>
